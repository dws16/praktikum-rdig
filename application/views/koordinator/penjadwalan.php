...
<div class="container-fluid">
  ...
  <div class="row justify-content-center mt-5">
    <div class="col-lg-10">
      <div class="card shadow mb-4 border-left-danger">
        <a href="#collapseSesi" class="d-block card-header py-3" data-toggle="collapse" role="button">
          <h6 class="m-0 font-weight-bold text-danger"><?= $title ?> Sesi Praktikum</h6>
        </a>
        <div class="card-body collapse show" id="collapseSesi">
          <div class="row">
  ...
  <div class="row justify-content-center mt-2">
    <div class="col-lg-11">
      <div class="card shadow mb-4 border-left-danger">
        <a href="#collapseJaga" class="d-block card-header py-3" data-toggle="collapse" role="button">
          <h6 class="m-0 font-weight-bold text-danger"><?= $title ?> Jaga Praktikum</h6>
        </a>
        <div class="card-body collapse show" id="collapseJaga">
          <div class="row">
            <div class="col mt-1 mb-3">
              <?php if ($this->session->flashdata('messageJaga')) : ?>
                <?= $this->session->flashdata('messageJaga') ?>
                <script>
                  $("#collapseSesi").removeClass("show");
                </script>
              <?php endif; ?>
            </div>
  ...
  <div class="row justify-content-center mt-2">
    <div class="col-lg-12">
      <div class="card shadow mb-4 border-left-danger">
        <a href="#collapsePraktikan" class="d-block card-header py-3" data-toggle="collapse" role="button">
          <h6 class="m-0 font-weight-bold text-danger"><?= $title ?> Praktikan</h6>
        </a>
        <div class="card-body collapse show" id="collapsePraktikan">
